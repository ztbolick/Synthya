...
public class KeyObserver extends FrontEnd {
            ...
            public void keyPressed(KeyEvent e) {
                switch (e.getKeyCode()) {
                    ...
                    case KeyEvent.VK_S:
                        ...
                        break;
                    case KeyEvent.VK_E:
                        SampleInterface.playSample(KeyEvent.VK_E);
                        break;
                    case KeyEvent.VK_D:
                    ...
                    case KeyEvent.VK_G:
                        ...
                        break;
                    case KeyEvent.VK_Y:
                        SampleInterface.playSample(KeyEvent.VK_Y);
                        break;
                    case KeyEvent.VK_H:
                        SampleInterface.playSample(KeyEvent.VK_H);
                        break;
                    case KeyEvent.VK_U:
                        SampleInterface.playSample(KeyEvent.VK_U);
                        break;
                    case KeyEvent.VK_J:
